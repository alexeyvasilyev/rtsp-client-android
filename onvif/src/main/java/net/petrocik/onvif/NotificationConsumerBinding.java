...
public class NotificationConsumerBinding
{
    ...
    public NotificationConsumerBinding (IServiceEvents callback)
    {
        this.callback = callback;
    }
    public NotificationConsumerBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public NotificationConsumerBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
