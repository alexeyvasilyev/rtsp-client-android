...
public class GetCompatibleAudioEncoderConfigurationsResponse extends Vector<AudioEncoderConfiguration> implements KvmSerializable
{
    ...
    public GetCompatibleAudioEncoderConfigurationsResponse(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public GetCompatibleAudioEncoderConfigurationsResponse(java.util.Collection< AudioEncoderConfiguration> initialCapactiy)
    {
        super(initialCapactiy);
    }
