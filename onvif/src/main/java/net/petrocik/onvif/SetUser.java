...
public class SetUser extends Vector<User> implements KvmSerializable
{
    ...
    public SetUser(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public SetUser(java.util.Collection< User> initialCapactiy)
    {
        super(initialCapactiy);
    }
