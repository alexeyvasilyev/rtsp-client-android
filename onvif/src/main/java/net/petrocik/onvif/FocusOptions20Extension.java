...
public  class FocusOptions20Extension extends AttributeContainer implements KvmSerializable
{
        ...
        if (info.name.equals("AFModes"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.AFModes = j.toString();
                    }
                }
                else{
                    this.AFModes = obj.toString();
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==0)
        {
            return this.AFModes!=null?this.AFModes:SoapPrimitive.NullSkip;
        }
