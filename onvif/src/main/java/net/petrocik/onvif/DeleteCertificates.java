...
public class DeleteCertificates extends Vector<String> implements KvmSerializable
{
    ...
    public DeleteCertificates(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public DeleteCertificates(java.util.Collection< String> initialCapactiy)
    {
        super(initialCapactiy);
    }
