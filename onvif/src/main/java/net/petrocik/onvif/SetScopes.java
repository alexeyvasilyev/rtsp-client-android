...
public class SetScopes extends Vector<String> implements KvmSerializable
{
    ...
    public SetScopes(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public SetScopes(java.util.Collection< String> initialCapactiy)
    {
        super(initialCapactiy);
    }
