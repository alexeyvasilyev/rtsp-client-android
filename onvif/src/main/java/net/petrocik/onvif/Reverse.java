...
public  class Reverse extends AttributeContainer implements KvmSerializable
{

    
    private transient java.lang.Object __source;    
    
    public Enums.ReverseMode Mode=Enums.ReverseMode.OFF;
        ...
        if (info.name.equals("Mode"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Mode = Enums.ReverseMode.fromString(j.toString());
                    }
                }
                else if (obj instanceof Enums.ReverseMode){
                    this.Mode = (Enums.ReverseMode)obj;
                }
            }
            return true;
        }
