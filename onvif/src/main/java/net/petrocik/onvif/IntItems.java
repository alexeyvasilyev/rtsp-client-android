...
public class IntItems extends Vector<Integer> implements KvmSerializable
{
    ...
    public IntItems(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public IntItems(java.util.Collection< Integer> initialCapactiy)
    {
        super(initialCapactiy);
    }
