...
public  class GetAudioOutputConfigurationOptions extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("AudioOutputToken"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.AudioOutputToken = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.AudioOutputToken = (String)obj;
                }
                else{
