...
public class IntList extends Vector<Integer> implements KvmSerializable
{
    ...
    public IntList(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public IntList(java.util.Collection< Integer> initialCapactiy)
    {
        super(initialCapactiy);
    }
