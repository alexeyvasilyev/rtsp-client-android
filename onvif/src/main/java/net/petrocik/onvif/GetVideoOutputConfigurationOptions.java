...
public  class GetVideoOutputConfigurationOptions extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("VideoOutputToken"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.VideoOutputToken = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.VideoOutputToken = (String)obj;
                }
                else{
                    this.VideoOutputToken = "";
                }
            }
            return true;
        }
