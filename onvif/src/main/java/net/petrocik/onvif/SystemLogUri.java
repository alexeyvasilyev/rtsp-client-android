...
public  class SystemLogUri extends AttributeContainer implements KvmSerializable
{

    
    private transient java.lang.Object __source;    
    
    public Enums.SystemLogType Type=Enums.SystemLogType.System;
        ...
        if (info.name.equals("Type"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Type = Enums.SystemLogType.fromString(j.toString());
                    }
                }
                else if (obj instanceof Enums.SystemLogType){
                    this.Type = (Enums.SystemLogType)obj;
                }
            }
            return true;
        }
