...
public  class SetVideoSourceConfiguration extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Configuration"))
        {
            if(obj!=null)
            {
                ...
                this.Configuration = (VideoSourceConfiguration)__envelope.get(j,VideoSourceConfiguration.class,false);
            }
            return true;
        }
