...
public class AddScopes extends Vector<String> implements KvmSerializable
{
    ...
    public AddScopes(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public AddScopes(java.util.Collection< String> initialCapactiy)
    {
        super(initialCapactiy);
    }
