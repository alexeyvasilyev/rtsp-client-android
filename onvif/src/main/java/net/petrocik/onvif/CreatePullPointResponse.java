...
public  class CreatePullPointResponse extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("PullPoint"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.PullPoint = (EndpointReferenceType)__envelope.get(j,EndpointReferenceType.class,false);
            }
            return true;
        }
        return false;
