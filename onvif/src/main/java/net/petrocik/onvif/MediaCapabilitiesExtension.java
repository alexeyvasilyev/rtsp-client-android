...
public  class MediaCapabilitiesExtension extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("ProfileCapabilities"))
        {
            if(obj!=null)
            {
                ...
                this.ProfileCapabilities = (ProfileCapabilities)__envelope.get(j,ProfileCapabilities.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            if(propertyIndex==0)
            {
                info.type = ProfileCapabilities.class;
