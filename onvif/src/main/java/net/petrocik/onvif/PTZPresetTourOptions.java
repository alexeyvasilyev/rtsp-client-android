...
public  class PTZPresetTourOptions extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("StartingCondition"))
        {
            if(obj!=null)
            {
                ...
                this.StartingCondition = (PTZPresetTourStartingConditionOptions)__envelope.get(j,PTZPresetTourStartingConditionOptions.class,false);
            }
            return true;
        }
        if (info.name.equals("TourSpot"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.TourSpot = (PTZPresetTourSpotOptions)__envelope.get(j,PTZPresetTourSpotOptions.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = PTZPresetTourStartingConditionOptions.class;
                info.name = "StartingCondition";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex==2)
            {
                info.type = PTZPresetTourSpotOptions.class;
                info.name = "TourSpot";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex>=3 && propertyIndex < 3+this.any.size())
