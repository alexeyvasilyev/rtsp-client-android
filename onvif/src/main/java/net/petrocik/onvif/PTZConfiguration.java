...
public  class PTZConfiguration extends ConfigurationEntity implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("DefaultPTZSpeed"))
        {
            if(obj!=null)
            {
                ...
                this.DefaultPTZSpeed = (PTZSpeed)__envelope.get(j,PTZSpeed.class,false);
            }
            return true;
        }
        if (info.name.equals("DefaultPTZTimeout"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.DefaultPTZTimeout = ExtendedSoapSerializationEnvelope.getDateTimeConverter().convertDuration(j.toString());
                    }
                }
                else if (obj instanceof String){
        ...
        if (info.name.equals("PanTiltLimits"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.PanTiltLimits = (PanTiltLimits)__envelope.get(j,PanTiltLimits.class,false);
            }
            return true;
        }
        if (info.name.equals("ZoomLimits"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.ZoomLimits = (ZoomLimits)__envelope.get(j,ZoomLimits.class,false);
            }
            return true;
        }
        if (info.name.equals("Extension"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Extension = (PTZConfigurationExtension)__envelope.get(j,PTZConfigurationExtension.class,false);
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return this.DefaultPTZTimeout!=null?ExtendedSoapSerializationEnvelope.getDateTimeConverter().getStringFromDuration(this.DefaultPTZTimeout):SoapPrimitive.NullSkip;
        }
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = PanTiltLimits.class;
                info.name = "PanTiltLimits";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex==count+10)
            {
                info.type = ZoomLimits.class;
                info.name = "ZoomLimits";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex==count+11)
            {
                info.type = PTZConfigurationExtension.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
