...
public  class SetVideoOutputConfiguration extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Configuration"))
        {
            if(obj!=null)
            {
                ...
                this.Configuration = (VideoOutputConfiguration)__envelope.get(j,VideoOutputConfiguration.class,false);
            }
            return true;
        }
