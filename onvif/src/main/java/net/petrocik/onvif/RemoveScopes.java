...
public class RemoveScopes extends Vector<String> implements KvmSerializable
{
    ...
    public RemoveScopes(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public RemoveScopes(java.util.Collection< String> initialCapactiy)
    {
        super(initialCapactiy);
    }
