...
public  class JpegOptions extends AttributeContainer implements KvmSerializable
{
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        else if(propertyIndex>=2+this.ResolutionsAvailable.size() && propertyIndex < 2+this.ResolutionsAvailable.size()+this.any.size())
        {
            return this.any.get(propertyIndex-(2+this.ResolutionsAvailable.size())).getValue();
        }
        return null;
    }
    ...
    public int getPropertyCount() {
        return 2+ResolutionsAvailable.size()+ any.size();
    }
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                PropertyInfo j=this.any.get(propertyIndex-(2+this.ResolutionsAvailable.size()));
                info.type = j.type;
                info.name = j.name;
