...
public class CreateUsers extends Vector<User> implements KvmSerializable
{
    ...
    public CreateUsers(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public CreateUsers(java.util.Collection< User> initialCapactiy)
    {
        super(initialCapactiy);
    }
