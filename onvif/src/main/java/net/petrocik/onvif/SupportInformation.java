...
public  class SupportInformation extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Binary"))
        {
            if(obj!=null)
            {
                ...
                this.Binary = (AttachmentData)__envelope.get(j,AttachmentData.class,false);
            }
            return true;
        }
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            if(propertyIndex==0)
            {
                info.type = AttachmentData.class;
                info.name = "Binary";
