...
public  class EventSubscription extends AttributeContainer implements KvmSerializable
{
    ...
    public EventSubscription_SubscriptionPolicy SubscriptionPolicy;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("SubscriptionPolicy"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.SubscriptionPolicy = (EventSubscription_SubscriptionPolicy)__envelope.get(j,EventSubscription_SubscriptionPolicy.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = EventSubscription_SubscriptionPolicy.class;
