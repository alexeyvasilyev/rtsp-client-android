...
public  class SetAudioOutputConfiguration extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Configuration"))
        {
            if(obj!=null)
            {
                ...
                this.Configuration = (AudioOutputConfiguration)__envelope.get(j,AudioOutputConfiguration.class,false);
            }
            return true;
        }
