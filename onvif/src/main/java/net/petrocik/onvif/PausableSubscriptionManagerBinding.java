...
public class PausableSubscriptionManagerBinding
{
    ...
    public PausableSubscriptionManagerBinding (IServiceEvents callback)
    {
        this.callback = callback;
    }
    public PausableSubscriptionManagerBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public PausableSubscriptionManagerBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public RenewResponse Renew(final Renew Renew) throws java.lang.Exception
    {
        ...
        },"http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/RenewRequest",__profile);
    }
    ...
    public String Unsubscribe(final Unsubscribe Unsubscribe) throws java.lang.Exception
    {
        ...
        },"http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/UnsubscribeRequest",__profile);
    }
    ...
    public String PauseSubscription(final PauseSubscription PauseSubscription) throws java.lang.Exception
    {
        com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile __profile = new com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile();
        return (String)execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                __envelope.addMapping("http://docs.oasis-open.org/wsn/b-2","PauseSubscription",PauseSubscription.class);
                __envelope.setOutputSoapObject(PauseSubscription);
                return __envelope;
            }
        ...
        },"http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/PauseSubscriptionRequest",__profile);
    }
    
    
    
    public android.os.AsyncTask< Void, Void, OperationResult< String>> PauseSubscriptionAsync(final PauseSubscription PauseSubscription)
    {
        return executeAsync(new Functions.IFunc< String>() {
            public String Func() throws java.lang.Exception {
                return PauseSubscription( PauseSubscription);
            }
        },"PauseSubscription");
    }
    ...
    public String ResumeSubscription(final ResumeSubscription ResumeSubscription) throws java.lang.Exception
    {
        com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile __profile = new com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile();
        return (String)execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                __envelope.addMapping("http://docs.oasis-open.org/wsn/b-2","ResumeSubscription",ResumeSubscription.class);
                __envelope.setOutputSoapObject(ResumeSubscription);
                return __envelope;
            }
        ...
        },"http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/ResumeSubscriptionRequest",__profile);
    }
    
    
    
    public android.os.AsyncTask< Void, Void, OperationResult< String>> ResumeSubscriptionAsync(final ResumeSubscription ResumeSubscription)
    {
        return executeAsync(new Functions.IFunc< String>() {
            public String Func() throws java.lang.Exception {
                return ResumeSubscription( ResumeSubscription);
            }
        },"ResumeSubscription");
    }
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,ExtendedSoapSerializationEnvelope envelope)
    {
        ...
        if(fault.detail!=null && fault.detail.getChildCount()>0)
        {
            ...
            try
            {
                ...
                exceptionObject=envelope.GetExceptionDetail(detailsNode,"http://docs.oasis-open.org/wsn/b-2","PauseFailedFault");
                if (exceptionObject != null)
                {
                    PauseFailedFaultType ex=new PauseFailedFaultType();
                    ex.loadFromSoap(exceptionObject,envelope);
                    newException = ex;
                }
                exceptionObject=envelope.GetExceptionDetail(detailsNode,"http://docs.oasis-open.org/wsn/b-2","ResumeFailedFault");
                if (exceptionObject != null)
                {
                    ResumeFailedFaultType ex=new ResumeFailedFaultType();
                    ex.loadFromSoap(exceptionObject,envelope);
                    newException = ex;
                }
            }
