...
public  class GetOSDOptions extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("ConfigurationToken"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.ConfigurationToken = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.ConfigurationToken = (String)obj;
                }
                else{
