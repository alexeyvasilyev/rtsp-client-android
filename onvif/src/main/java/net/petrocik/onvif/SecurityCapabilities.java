...
public  class SecurityCapabilities extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (SecurityCapabilitiesExtension)__envelope.get(j,SecurityCapabilitiesExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        else if(propertyIndex>=9 && propertyIndex < 9+this.any.size())
        {
            return this.any.get(propertyIndex-(9)).getValue();
        }
        return null;
    }
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = SecurityCapabilitiesExtension.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex>=9 && propertyIndex < 9+this.any.size())
            {
                PropertyInfo j=this.any.get(propertyIndex-(9));
                info.type = j.type;
                info.name = j.name;
