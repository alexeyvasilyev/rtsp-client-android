...
public  class IrCutFilterAutoAdjustment extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("ResponseTime"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.ResponseTime = ExtendedSoapSerializationEnvelope.getDateTimeConverter().convertDuration(j.toString());
                    }
                }
                else if (obj instanceof String){
        ...
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (IrCutFilterAutoAdjustmentExtension)__envelope.get(j,IrCutFilterAutoAdjustmentExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return this.ResponseTime!=null?ExtendedSoapSerializationEnvelope.getDateTimeConverter().getStringFromDuration(this.ResponseTime):SoapPrimitive.NullSkip;
        }
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = IrCutFilterAutoAdjustmentExtension.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
    }
