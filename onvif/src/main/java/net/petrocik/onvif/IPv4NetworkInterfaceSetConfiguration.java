...
public  class IPv4NetworkInterfaceSetConfiguration extends AttributeContainer implements KvmSerializable
{
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            PrefixedIPv4Address Manual = this.Manual.get(propertyIndex-(1));
