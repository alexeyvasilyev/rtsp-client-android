...
public abstract class ExtensibleDocumented extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("documentation"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.documentation = (Documentation)__envelope.get(j,Documentation.class,false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==0)
        {
            return this.documentation!=null?this.documentation:SoapPrimitive.NullSkip;
        }
