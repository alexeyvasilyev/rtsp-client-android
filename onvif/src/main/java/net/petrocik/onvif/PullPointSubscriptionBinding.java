...
public class PullPointSubscriptionBinding
{
    ...
    public PullPointSubscriptionBinding (IServiceEvents callback)
    {
        this.callback = callback;
    }
    public PullPointSubscriptionBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public PullPointSubscriptionBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public PullMessagesResponse PullMessages(final PullMessages PullMessages) throws java.lang.Exception
    {
        ...
        return (PullMessagesResponse)execute(new IWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                __envelope.addMapping("http://www.onvif.org/ver10/events/wsdl","PullMessages",PullMessages.class);
                __envelope.setOutputSoapObject(PullMessages);
                return __envelope;
            }
            ...
            public java.lang.Object ProcessResult(ExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
                return (PullMessagesResponse)getResult(PullMessagesResponse.class,__result,"PullMessagesResponse",__envelope);
            }
    ...
    public android.os.AsyncTask< Void, Void, OperationResult< PullMessagesResponse>> PullMessagesAsync(final PullMessages PullMessages)
    {
        return executeAsync(new Functions.IFunc< PullMessagesResponse>() {
            public PullMessagesResponse Func() throws java.lang.Exception {
                return PullMessages( PullMessages);
            }
        },"PullMessages");
    }
    ...
    public void Seek(final Seek Seek) throws java.lang.Exception
    {
        com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile __profile = new com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile();
        execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                __envelope.addMapping("http://www.onvif.org/ver10/events/wsdl","Seek",Seek.class);
                __envelope.setOutputSoapObject(Seek);
                return __envelope;
            }
    ...
    public android.os.AsyncTask< Void, Void, OperationResult< Void>> SeekAsync(final Seek Seek)
    {
    ...
    public void SetSynchronizationPoint() throws java.lang.Exception
    {
        ...
        execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                SoapObject __soapReq = new SoapObject("http://www.onvif.org/ver10/events/wsdl", "SetSynchronizationPoint");
        ...
        },"http://www.onvif.org/ver10/events/wsdl/PullPointSubscription/SetSynchronizationPointRequest",__profile);
    }
    
    
    
    public android.os.AsyncTask< Void, Void, OperationResult< Void>> SetSynchronizationPointAsync()
    {
        return executeAsync(new Functions.IFunc< Void>()
        {
            @Override
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,ExtendedSoapSerializationEnvelope envelope)
    {
        ...
        if(fault.detail!=null && fault.detail.getChildCount()>0)
        {
            ...
            try
            {
                ...
                {
                    PullMessagesFaultResponse ex=new PullMessagesFaultResponse();
