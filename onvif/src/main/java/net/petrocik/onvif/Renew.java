...
public  class Renew extends AttributeContainer implements KvmSerializable
{
        ...
        if (info.name.equals("TerminationTime"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.TerminationTime = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.TerminationTime = (String)obj;
                }
                else{
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==0)
        {
            return this.TerminationTime!=null?this.TerminationTime:SoapPrimitive.NullNilElement;
        }
