...
public  class GetOSDOptionsResponse extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("OSDOptions"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.OSDOptions = (OSDConfigurationOptions)__envelope.get(j,OSDConfigurationOptions.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            if(propertyIndex==0)
            {
                info.type = OSDConfigurationOptions.class;
                info.name = "OSDOptions";
