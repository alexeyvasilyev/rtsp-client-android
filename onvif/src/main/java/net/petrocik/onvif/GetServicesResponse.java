...
public class GetServicesResponse extends Vector<Service> implements KvmSerializable
{
    ...
    public GetServicesResponse(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public GetServicesResponse(java.util.Collection< Service> initialCapactiy)
    {
        super(initialCapactiy);
    }
