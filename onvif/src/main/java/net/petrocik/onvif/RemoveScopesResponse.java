...
public class RemoveScopesResponse extends Vector<String> implements KvmSerializable
{
    ...
    public RemoveScopesResponse(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public RemoveScopesResponse(java.util.Collection< String> initialCapactiy)
    {
        super(initialCapactiy);
    }
