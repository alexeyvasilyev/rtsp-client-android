...
public class DeleteUsers extends Vector<String> implements KvmSerializable
{
    ...
    public DeleteUsers(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public DeleteUsers(java.util.Collection< String> initialCapactiy)
    {
        super(initialCapactiy);
    }
