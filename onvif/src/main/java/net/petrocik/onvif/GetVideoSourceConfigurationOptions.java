...
public  class GetVideoSourceConfigurationOptions extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("VideoSourceToken"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.VideoSourceToken = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.VideoSourceToken = (String)obj;
                }
                else{
