...
public class SetCertificatesStatus extends Vector<CertificateStatus> implements KvmSerializable
{
    ...
    public SetCertificatesStatus(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public SetCertificatesStatus(java.util.Collection< CertificateStatus> initialCapactiy)
    {
        super(initialCapactiy);
    }
