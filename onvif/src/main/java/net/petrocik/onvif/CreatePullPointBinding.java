...
public class CreatePullPointBinding
{
    ...
    public CreatePullPointBinding (IServiceEvents callback)
    {
        this.callback = callback;
    }
    public CreatePullPointBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public CreatePullPointBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public CreatePullPointResponse CreatePullPoint(final CreatePullPoint CreatePullPoint) throws java.lang.Exception
    {
        ...
        return (CreatePullPointResponse)execute(new IWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                __envelope.addMapping("http://docs.oasis-open.org/wsn/b-2","CreatePullPoint",CreatePullPoint.class);
                __envelope.setOutputSoapObject(CreatePullPoint);
                return __envelope;
            }
            ...
            public java.lang.Object ProcessResult(ExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
                return (CreatePullPointResponse)getResult(CreatePullPointResponse.class,__result,"CreatePullPointResponse",__envelope);
            }
        },"http://docs.oasis-open.org/wsn/bw-2/CreatePullPoint/CreatePullPointRequest",__profile);
    }
    
    
    
    public android.os.AsyncTask< Void, Void, OperationResult< CreatePullPointResponse>> CreatePullPointAsync(final CreatePullPoint CreatePullPoint)
    {
        return executeAsync(new Functions.IFunc< CreatePullPointResponse>() {
            public CreatePullPointResponse Func() throws java.lang.Exception {
                return CreatePullPoint( CreatePullPoint);
            }
        },"CreatePullPoint");
    }
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,ExtendedSoapSerializationEnvelope envelope)
    {
        ...
        if(fault.detail!=null && fault.detail.getChildCount()>0)
        {
            ...
            try
            {
                ...
                exceptionObject=envelope.GetExceptionDetail(detailsNode,"http://docs.oasis-open.org/wsn/b-2","UnableToCreatePullPointFault");
                if (exceptionObject != null)
                {
                    UnableToCreatePullPointFaultType ex=new UnableToCreatePullPointFaultType();
