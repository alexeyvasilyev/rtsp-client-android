...
public  class VideoSourceExtension extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Imaging"))
        {
            if(obj!=null)
            {
                ...
                this.Imaging = (ImagingSettings20)__envelope.get(j,ImagingSettings20.class,false);
            }
            return true;
        }
        if (info.name.equals("Extension"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Extension = (VideoSourceExtension2)__envelope.get(j,VideoSourceExtension2.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            if(propertyIndex==0)
            {
                info.type = ImagingSettings20.class;
                info.name = "Imaging";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex==1)
            {
                info.type = VideoSourceExtension2.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex>=2 && propertyIndex < 2+this.any.size())
