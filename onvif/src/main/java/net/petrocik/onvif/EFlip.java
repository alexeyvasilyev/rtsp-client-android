...
public  class EFlip extends AttributeContainer implements KvmSerializable
{

    
    private transient java.lang.Object __source;    
    
    public Enums.EFlipMode Mode=Enums.EFlipMode.OFF;
        ...
        if (info.name.equals("Mode"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Mode = Enums.EFlipMode.fromString(j.toString());
                    }
                }
                else if (obj instanceof Enums.EFlipMode){
                    this.Mode = (Enums.EFlipMode)obj;
                }
            }
            return true;
        }
