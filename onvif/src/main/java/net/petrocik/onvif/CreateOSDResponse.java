...
public  class CreateOSDResponse extends AttributeContainer implements KvmSerializable
{
        ...
        if (info.name.equals("OSDToken"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.OSDToken = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.OSDToken = (String)obj;
                }
                else{
                    this.OSDToken = "";
                }
