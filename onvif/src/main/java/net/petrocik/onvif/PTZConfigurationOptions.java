...
public  class PTZConfigurationOptions extends AttributeContainer implements KvmSerializable
{
    ...
    public void loadFromSoap(java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        {	
            java.lang.Object j = inObj.getAttribute("PTZRamps");
            if (j != null)
            {
                PTZRamps = j.toString();
            }
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Spaces"))
        {
            if(obj!=null)
            {
                ...
                this.Spaces = (PTZSpaces)__envelope.get(j,PTZSpaces.class,false);
            }
            return true;
        }
        if (info.name.equals("PTZTimeout"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.PTZTimeout = (DurationRange)__envelope.get(j,DurationRange.class,false);
            }
            return true;
        }
        if (info.name.equals("PTControlDirection"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.PTControlDirection = (PTControlDirectionOptions)__envelope.get(j,PTControlDirectionOptions.class,false);
            }
            return true;
        }
        if (info.name.equals("Extension"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Extension = (PTZConfigurationOptions2)__envelope.get(j,PTZConfigurationOptions2.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = PTControlDirectionOptions.class;
                info.name = "PTControlDirection";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex==3)
            {
                info.type = PTZConfigurationOptions2.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex>=4 && propertyIndex < 4+this.any.size())
