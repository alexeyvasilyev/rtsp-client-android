...
public  class DeviceCapabilities extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Network"))
        {
            if(obj!=null)
            {
                ...
                this.Network = (NetworkCapabilities)__envelope.get(j,NetworkCapabilities.class,false);
            }
            return true;
        }
        if (info.name.equals("System"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.System = (SystemCapabilities)__envelope.get(j,SystemCapabilities.class,false);
            }
            return true;
        }
        if (info.name.equals("IO"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.IO = (IOCapabilities)__envelope.get(j,IOCapabilities.class,false);
            }
            return true;
        }
        if (info.name.equals("Security"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Security = (SecurityCapabilities)__envelope.get(j,SecurityCapabilities.class,false);
            }
            return true;
        }
        if (info.name.equals("Extension"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Extension = (DeviceCapabilitiesExtension)__envelope.get(j,DeviceCapabilitiesExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = NetworkCapabilities.class;
                info.name = "Network";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex==2)
            {
                info.type = SystemCapabilities.class;
                info.name = "System";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex==3)
            {
                info.type = IOCapabilities.class;
                info.name = "IO";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex==4)
            {
                info.type = SecurityCapabilities.class;
                info.name = "Security";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex==5)
            {
                info.type = DeviceCapabilitiesExtension.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
    }
