...
public  class UIINetworkCapabilitiesExtension extends AttributeContainer implements KvmSerializable
{
    ...
    public UIINetworkCapabilitiesExtension2 Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (UIINetworkCapabilitiesExtension2)__envelope.get(j,UIINetworkCapabilitiesExtension2.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = UIINetworkCapabilitiesExtension2.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
    }
