...
public  class UIIIPv6Configuration extends AttributeContainer implements KvmSerializable
{
    ...
    public UIIEnums.IPv6DHCPConfiguration DHCP=UIIEnums.IPv6DHCPConfiguration.Auto;
    
    public java.util.ArrayList< UIIPrefixedIPv6Address> Manual =new java.util.ArrayList<UIIPrefixedIPv6Address >();
    
    public java.util.ArrayList< UIIPrefixedIPv6Address> LinkLocal =new java.util.ArrayList<UIIPrefixedIPv6Address >();
    
    public java.util.ArrayList< UIIPrefixedIPv6Address> FromDHCP =new java.util.ArrayList<UIIPrefixedIPv6Address >();
    
    public java.util.ArrayList< UIIPrefixedIPv6Address> FromRA =new java.util.ArrayList<UIIPrefixedIPv6Address >();
    
    public UIIIPv6ConfigurationExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("LinkLocal"))
        {
            if(obj!=null)
            {
                ...
                {
                    this.LinkLocal = new java.util.ArrayList< UIIPrefixedIPv6Address>();
                }
                java.lang.Object j =obj;
                UIIPrefixedIPv6Address j1= (UIIPrefixedIPv6Address)__envelope.get(j,UIIPrefixedIPv6Address.class,false);
        ...
        if (info.name.equals("FromDHCP"))
        {
            if(obj!=null)
            {
                ...
                {
                    this.FromDHCP = new java.util.ArrayList< UIIPrefixedIPv6Address>();
                }
                java.lang.Object j =obj;
                UIIPrefixedIPv6Address j1= (UIIPrefixedIPv6Address)__envelope.get(j,UIIPrefixedIPv6Address.class,false);
        ...
        if (info.name.equals("FromRA"))
        {
            if(obj!=null)
            {
                if(this.FromRA==null)
                {
                    this.FromRA = new java.util.ArrayList< UIIPrefixedIPv6Address>();
                }
                java.lang.Object j =obj;
                UIIPrefixedIPv6Address j1= (UIIPrefixedIPv6Address)__envelope.get(j,UIIPrefixedIPv6Address.class,false);
                this.FromRA.add(j1);
        ...
        if (info.name.equals("Extension"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Extension = (UIIIPv6ConfigurationExtension)__envelope.get(j,UIIIPv6ConfigurationExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            UIIPrefixedIPv6Address LinkLocal = this.LinkLocal.get(propertyIndex-(2+this.Manual.size()));
        ...
        {
            UIIPrefixedIPv6Address FromDHCP = this.FromDHCP.get(propertyIndex-(2+this.Manual.size()+this.LinkLocal.size()));
        ...
        {
            UIIPrefixedIPv6Address FromRA = this.FromRA.get(propertyIndex-(2+this.Manual.size()+this.LinkLocal.size()+this.FromDHCP.size()));
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = UIIIPv6ConfigurationExtension.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
    }
