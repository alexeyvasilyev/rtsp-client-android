...
public  class UIIDigitalInput extends UIIDeviceEntity implements KvmSerializable
{

    
    public UIIEnums.DigitalIdleState IdleState=UIIEnums.DigitalIdleState.closed;
    ...
    public void loadFromSoap(java.lang.Object paramObj,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        {	
            ...
            if (j != null)
            {
                IdleState = UIIEnums.DigitalIdleState.fromString(j.toString());
            }
        }
