...
public class UIIDeleteUsers extends Vector<String> implements KvmSerializable
{
    private transient java.lang.Object __source;

    public UIIDeleteUsers()
    {
    }

    public UIIDeleteUsers(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public UIIDeleteUsers(java.util.Collection< String> initialCapactiy)
    {
        super(initialCapactiy);
    }
