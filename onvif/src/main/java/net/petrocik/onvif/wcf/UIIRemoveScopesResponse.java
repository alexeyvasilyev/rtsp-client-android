...
public class UIIRemoveScopesResponse extends Vector<String> implements KvmSerializable
{
    private transient java.lang.Object __source;

    public UIIRemoveScopesResponse()
    {
    }

    public UIIRemoveScopesResponse(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public UIIRemoveScopesResponse(java.util.Collection< String> initialCapactiy)
    {
        super(initialCapactiy);
    }
