...
public  class UIIImagingSettings extends AttributeContainer implements KvmSerializable
{

    
    private transient java.lang.Object __source;    
    
    public UIIBacklightCompensation BacklightCompensation;
    ...
    public UIIExposure Exposure;
    
    public UIIFocusConfiguration Focus;
    
    public UIIEnums.IrCutFilterMode IrCutFilter;
    
    public Float Sharpness;
    
    public UIIWideDynamicRange WideDynamicRange;
    
    public UIIWhiteBalance WhiteBalance;
    
    public UIIImagingSettingsExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("BacklightCompensation"))
        {
            if(obj!=null)
            {
                ...
                this.BacklightCompensation = (UIIBacklightCompensation)__envelope.get(j,UIIBacklightCompensation.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("Exposure"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Exposure = (UIIExposure)__envelope.get(j,UIIExposure.class,false);
            }
            return true;
        }
        if (info.name.equals("Focus"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Focus = (UIIFocusConfiguration)__envelope.get(j,UIIFocusConfiguration.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("WideDynamicRange"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.WideDynamicRange = (UIIWideDynamicRange)__envelope.get(j,UIIWideDynamicRange.class,false);
            }
            return true;
        }
        if (info.name.equals("WhiteBalance"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.WhiteBalance = (UIIWhiteBalance)__envelope.get(j,UIIWhiteBalance.class,false);
            }
            return true;
        }
        if (info.name.equals("Extension"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Extension = (UIIImagingSettingsExtension)__envelope.get(j,UIIImagingSettingsExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            if(propertyIndex==0)
            {
                info.type = UIIBacklightCompensation.class;
            ...
            {
                info.type = UIIExposure.class;
                info.name = "Exposure";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex==5)
            {
                info.type = UIIFocusConfiguration.class;
                info.name = "Focus";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex==6)
            ...
            {
                info.type = UIIWideDynamicRange.class;
                info.name = "WideDynamicRange";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex==9)
            {
                info.type = UIIWhiteBalance.class;
                info.name = "WhiteBalance";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex==10)
            {
                info.type = UIIImagingSettingsExtension.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
    }
