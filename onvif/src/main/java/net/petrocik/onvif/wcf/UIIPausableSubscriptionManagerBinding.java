...
public class UIIPausableSubscriptionManagerBinding
{
    ...
    public UIIPausableSubscriptionManagerBinding(){}

    public UIIPausableSubscriptionManagerBinding (UIIIServiceEvents callback)
    {
        this.callback = callback;
    }
    public UIIPausableSubscriptionManagerBinding(UIIIServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public UIIPausableSubscriptionManagerBinding(UIIIServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public void Unsubscribe() throws java.lang.Exception
    {
        ...
        execute(new UIIIWcfMethod()
        {
            ...
            public UIIExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                UIIExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                SoapObject __soapReq = new SoapObject("http://docs.oasis-open.org/wsn/b-2", "Unsubscribe");
                __envelope.setOutputSoapObject(__soapReq);
	...
	*/
    ...
    public void PauseSubscription() throws java.lang.Exception
    {
...
/*This feature is available in Premium account. To test if generated classes work correctly with your webservice, please use different method. Check https://EasyWsdl.com/Payment/PremiumAccountDetails to see all benefits of Premium account.*/
	...
	*/
    ...
    public android.os.AsyncTask< Void, Void, UIIOperationResult< Void>> PauseSubscriptionAsync()
    {
        return executeAsync(new UIIFunctions.IFunc< Void>()
        {
            @Override
	...
	*/
    ...
    public void ResumeSubscription() throws java.lang.Exception
    {
...
/*This feature is available in Premium account. To test if generated classes work correctly with your webservice, please use different method. Check https://EasyWsdl.com/Payment/PremiumAccountDetails to see all benefits of Premium account.*/
	...
	*/
    ...
    public android.os.AsyncTask< Void, Void, UIIOperationResult< Void>> ResumeSubscriptionAsync()
    {
        return executeAsync(new UIIFunctions.IFunc< Void>()
        {
            @Override
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,UIIExtendedSoapSerializationEnvelope envelope)
    {
        ...
        if(fault.detail!=null && fault.detail.getChildCount()>0)
        {
            ...
            try
            {
                ...
                if (exceptionObject != null)
                {
                    UIIPauseFailedFaultType ex=new UIIPauseFailedFaultType();
                    ex.loadFromSoap(exceptionObject,envelope);
                    newException = ex;
                }
                ...
                if (exceptionObject != null)
                {
                    UIIResumeFailedFaultType ex=new UIIResumeFailedFaultType();
                    ex.loadFromSoap(exceptionObject,envelope);
                    newException = ex;
                }
            }
