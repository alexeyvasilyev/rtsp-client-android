...
public class UIIPullPointSubscriptionBinding
{
    ...
    public UIIPullPointSubscriptionBinding(){}

    public UIIPullPointSubscriptionBinding (UIIIServiceEvents callback)
    {
        this.callback = callback;
    }
    public UIIPullPointSubscriptionBinding(UIIIServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public UIIPullPointSubscriptionBinding(UIIIServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public UIIPullMessagesResponse PullMessages(final String Timeout,final Integer MessageLimit) throws java.lang.Exception
    {
        ...
        return (UIIPullMessagesResponse)execute(new UIIIWcfMethod()
        {
            @Override
            public UIIExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                SoapObject __soapReq = new SoapObject("http://www.onvif.org/ver10/events/wsdl", "PullMessages");
                ...
                __info.setValue(Timeout!=null?UIIExtendedSoapSerializationEnvelope.getDateTimeConverter().getStringFromDuration(Timeout):SoapPrimitive.NullSkip);
                __soapReq.addProperty(__info);
                __info = new PropertyInfo();
                __info.namespace="http://www.onvif.org/ver10/events/wsdl";
                __info.name="MessageLimit";
                __info.type=PropertyInfo.INTEGER_CLASS;
                __info.setValue(MessageLimit);
                __soapReq.addProperty(__info);
                return __envelope;
            }
            ...
            public java.lang.Object ProcessResult(UIIExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
                return (UIIPullMessagesResponse)getResult(UIIPullMessagesResponse.class,__result,"PullMessagesResponse",__envelope);
            }
        },"http://www.onvif.org/ver10/events/wsdl/PullPointSubscription/PullMessagesRequest",__profile);
    }
    
    
    
    public android.os.AsyncTask< Void, Void, UIIOperationResult< UIIPullMessagesResponse>> PullMessagesAsync(final String Timeout,final Integer MessageLimit)
    {
        return executeAsync(new UIIFunctions.IFunc< UIIPullMessagesResponse>() {
            public UIIPullMessagesResponse Func() throws java.lang.Exception {
                return PullMessages( Timeout,MessageLimit);
            }
        },"PullMessages");
    }
    ...
    public void Seek(final java.util.Date UtcTime,final Boolean Reverse) throws java.lang.Exception
    {
        com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile __profile = new com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile();
        execute(new UIIIWcfMethod()
        {
            ...
            public UIIExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                UIIExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                SoapObject __soapReq = new SoapObject("http://www.onvif.org/ver10/events/wsdl", "Seek");
                __envelope.setOutputSoapObject(__soapReq);
                ...
                __info.name="UtcTime";
                __info.type=PropertyInfo.STRING_CLASS;
                __info.setValue(UtcTime!=null?UIIExtendedSoapSerializationEnvelope.getDateTimeConverter().getStringFromDateTime(UtcTime):SoapPrimitive.NullSkip);
                __soapReq.addProperty(__info);
                __info = new PropertyInfo();
                __info.namespace="http://www.onvif.org/ver10/events/wsdl";
                __info.name="Reverse";
                __info.type=PropertyInfo.BOOLEAN_CLASS;
                __info.setValue(Reverse!=null?Reverse:SoapPrimitive.NullSkip);
                __soapReq.addProperty(__info);
                return __envelope;
            }
        ...
        },"http://www.onvif.org/ver10/events/wsdl/PullPointSubscription/SeekRequest",__profile);
    }
    
    
    
    public android.os.AsyncTask< Void, Void, UIIOperationResult< Void>> SeekAsync(final java.util.Date UtcTime,final Boolean Reverse)
    {
        return executeAsync(new UIIFunctions.IFunc< Void>()
        {
            @Override
            public Void Func() throws java.lang.Exception {
                Seek( UtcTime,Reverse);
                return null;
            }
        },"Seek") ;
    }
	...
	*/
    ...
    public void SetSynchronizationPoint() throws java.lang.Exception
    {
...
/*This feature is available in Premium account. To test if generated classes work correctly with your webservice, please use different method. Check https://EasyWsdl.com/Payment/PremiumAccountDetails to see all benefits of Premium account.*/
	...
	*/
    ...
    public android.os.AsyncTask< Void, Void, UIIOperationResult< Void>> SetSynchronizationPointAsync()
    {
        return executeAsync(new UIIFunctions.IFunc< Void>()
        {
            @Override
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,UIIExtendedSoapSerializationEnvelope envelope)
    {
        ...
        if(fault.detail!=null && fault.detail.getChildCount()>0)
        {
            ...
            try
            {
                ...
                exceptionObject=envelope.GetExceptionDetail(detailsNode,"http://www.onvif.org/ver10/events/wsdl","PullMessagesFaultResponse");
                if (exceptionObject != null)
                {
                    UIIPullMessagesFaultResponse ex=new UIIPullMessagesFaultResponse();
