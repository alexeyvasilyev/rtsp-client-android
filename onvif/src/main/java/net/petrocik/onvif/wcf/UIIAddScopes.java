...
public class UIIAddScopes extends Vector<String> implements KvmSerializable
{
    ...
    public UIIAddScopes(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public UIIAddScopes(java.util.Collection< String> initialCapactiy)
    {
        super(initialCapactiy);
    }
