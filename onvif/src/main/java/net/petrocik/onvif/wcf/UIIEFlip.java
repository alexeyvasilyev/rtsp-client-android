...
public  class UIIEFlip extends AttributeContainer implements KvmSerializable
{

    
    private transient java.lang.Object __source;    
    
    public UIIEnums.EFlipMode Mode=UIIEnums.EFlipMode.OFF;
        ...
        if (info.name.equals("Mode"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Mode = UIIEnums.EFlipMode.fromString(j.toString());
                    }
                }
                else if (obj instanceof UIIEnums.EFlipMode){
                    this.Mode = (UIIEnums.EFlipMode)obj;
                }
            }
            return true;
        }
