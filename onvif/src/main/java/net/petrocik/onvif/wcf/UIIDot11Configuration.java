...
public  class UIIDot11Configuration extends AttributeContainer implements KvmSerializable
{
    ...
    public UIIEnums.Dot11StationMode Mode=UIIEnums.Dot11StationMode.Ad_x002D_hoc;
    
    public String Alias;
    
    public BigInteger Priority=BigInteger.ZERO;
    
    public UIIDot11SecurityConfiguration Security;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Mode"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Mode = UIIEnums.Dot11StationMode.fromString(j.toString());
                    }
                }
                else if (obj instanceof UIIEnums.Dot11StationMode){
                    this.Mode = (UIIEnums.Dot11StationMode)obj;
                }
            }
            return true;
        }
        ...
        if (info.name.equals("Security"))
        {
            if(obj!=null)
            {
                ...
                this.Security = (UIIDot11SecurityConfiguration)__envelope.get(j,UIIDot11SecurityConfiguration.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = UIIDot11SecurityConfiguration.class;
                info.name = "Security";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
    }
