...
public  class UIIEngineConfiguration extends AttributeContainer implements KvmSerializable
{
    ...
    public UIIAnalyticsEngineInputInfo AnalyticsEngineInputInfo;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("AnalyticsEngineInputInfo"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.AnalyticsEngineInputInfo = (UIIAnalyticsEngineInputInfo)__envelope.get(j,UIIAnalyticsEngineInputInfo.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = UIIAnalyticsEngineInputInfo.class;
