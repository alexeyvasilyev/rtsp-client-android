...
public  class UIIConfig extends AttributeContainer implements KvmSerializable
{

    
    private transient java.lang.Object __source;    
    
    public UIIItemList Parameters;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Parameters"))
        {
            if(obj!=null)
            {
                ...
                this.Parameters = (UIIItemList)__envelope.get(j,UIIItemList.class,false);
            }
            return true;
        }
        return false;
