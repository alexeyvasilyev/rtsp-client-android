...
public  class UIIIPv6NetworkInterface extends AttributeContainer implements KvmSerializable
{
    ...
    public UIIIPv6Configuration Config;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Config"))
        {
            if(obj!=null)
            {
                ...
                this.Config = (UIIIPv6Configuration)__envelope.get(j,UIIIPv6Configuration.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = UIIIPv6Configuration.class;
                info.name = "Config";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
    }
