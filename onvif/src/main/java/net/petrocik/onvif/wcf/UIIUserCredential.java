...
public  class UIIUserCredential extends AttributeContainer implements KvmSerializable
{
    ...
    public UIIUserCredential_Extension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (UIIUserCredential_Extension)__envelope.get(j,UIIUserCredential_Extension.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = UIIUserCredential_Extension.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/device/wsdl";
            }
    }
