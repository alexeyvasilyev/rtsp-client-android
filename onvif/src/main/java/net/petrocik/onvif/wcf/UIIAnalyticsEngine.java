...
public  class UIIAnalyticsEngine extends UIIConfigurationEntity implements KvmSerializable
{

    
    public UIIAnalyticsDeviceEngineConfiguration AnalyticsEngineConfiguration;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("AnalyticsEngineConfiguration"))
        {
            if(obj!=null)
            {
                ...
                this.AnalyticsEngineConfiguration = (UIIAnalyticsDeviceEngineConfiguration)__envelope.get(j,UIIAnalyticsDeviceEngineConfiguration.class,false);
            }
            return true;
        }
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            if(propertyIndex==count+0)
            {
                info.type = UIIAnalyticsDeviceEngineConfiguration.class;
