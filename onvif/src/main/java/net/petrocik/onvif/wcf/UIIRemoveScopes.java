...
public class UIIRemoveScopes extends Vector<String> implements KvmSerializable
{
    private transient java.lang.Object __source;

    public UIIRemoveScopes()
    {
    }

    public UIIRemoveScopes(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public UIIRemoveScopes(java.util.Collection< String> initialCapactiy)
    {
        super(initialCapactiy);
    }
