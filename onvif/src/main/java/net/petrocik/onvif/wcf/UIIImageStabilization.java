...
public  class UIIImageStabilization extends AttributeContainer implements KvmSerializable
{

    
    private transient java.lang.Object __source;    
    
    public UIIEnums.ImageStabilizationMode Mode=UIIEnums.ImageStabilizationMode.OFF;
    
    public Float Level;
    
    public UIIImageStabilizationExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Mode"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Mode = UIIEnums.ImageStabilizationMode.fromString(j.toString());
                    }
                }
                else if (obj instanceof UIIEnums.ImageStabilizationMode){
                    this.Mode = (UIIEnums.ImageStabilizationMode)obj;
                }
            }
            return true;
        }
        ...
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (UIIImageStabilizationExtension)__envelope.get(j,UIIImageStabilizationExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = UIIImageStabilizationExtension.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
    }
