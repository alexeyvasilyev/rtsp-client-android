...
public class UIICreatePullPointBinding
{
    ...
    public UIICreatePullPointBinding(){}

    public UIICreatePullPointBinding (UIIIServiceEvents callback)
    {
        this.callback = callback;
    }
    public UIICreatePullPointBinding(UIIIServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public UIICreatePullPointBinding(UIIIServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public UIIEndpointReferenceType CreatePullPoint() throws java.lang.Exception
    {
        ...
        return (UIIEndpointReferenceType)execute(new UIIIWcfMethod()
        {
            @Override
            public UIIExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                SoapObject __soapReq = new SoapObject("http://docs.oasis-open.org/wsn/b-2", "CreatePullPoint");
            ...
            public java.lang.Object ProcessResult(UIIExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
                return (UIIEndpointReferenceType)getResult(UIIEndpointReferenceType.class,__result,"PullPoint",__envelope);
            }
    ...
    public android.os.AsyncTask< Void, Void, UIIOperationResult< UIIEndpointReferenceType>> CreatePullPointAsync()
    {
        return executeAsync(new UIIFunctions.IFunc< UIIEndpointReferenceType>() {
            public UIIEndpointReferenceType Func() throws java.lang.Exception {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,UIIExtendedSoapSerializationEnvelope envelope)
    {
        ...
        if(fault.detail!=null && fault.detail.getChildCount()>0)
        {
            ...
            try
            {
                ...
                {
                    UIIUnableToCreatePullPointFaultType ex=new UIIUnableToCreatePullPointFaultType();
