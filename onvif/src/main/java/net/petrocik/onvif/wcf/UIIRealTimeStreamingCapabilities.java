...
public  class UIIRealTimeStreamingCapabilities extends AttributeContainer implements KvmSerializable
{
    ...
    public UIIRealTimeStreamingCapabilitiesExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (UIIRealTimeStreamingCapabilitiesExtension)__envelope.get(j,UIIRealTimeStreamingCapabilitiesExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = UIIRealTimeStreamingCapabilitiesExtension.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
    }
