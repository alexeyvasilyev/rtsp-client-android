...
public  class UIIAudioEncoderConfiguration extends UIIConfigurationEntity implements KvmSerializable
{

    
    public UIIEnums.AudioEncoding Encoding=UIIEnums.AudioEncoding.G711;
        ...
        if (info.name.equals("Encoding"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Encoding = UIIEnums.AudioEncoding.fromString(j.toString());
                    }
                }
                else if (obj instanceof UIIEnums.AudioEncoding){
                    this.Encoding = (UIIEnums.AudioEncoding)obj;
                }
            }
            return true;
        }
