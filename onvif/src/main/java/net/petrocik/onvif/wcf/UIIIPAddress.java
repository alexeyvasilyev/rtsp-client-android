...
public  class UIIIPAddress extends AttributeContainer implements KvmSerializable
{

    
    private transient java.lang.Object __source;    
    
    public UIIEnums.IPType Type=UIIEnums.IPType.IPv4;
        ...
        if (info.name.equals("Type"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Type = UIIEnums.IPType.fromString(j.toString());
                    }
                }
                else if (obj instanceof UIIEnums.IPType){
                    this.Type = (UIIEnums.IPType)obj;
                }
            }
            return true;
        }
