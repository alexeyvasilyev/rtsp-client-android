...
public  class UIIUser extends AttributeContainer implements KvmSerializable
{
    ...
    public UIIEnums.UserLevel UserLevel=UIIEnums.UserLevel.Administrator;
    
    public UIIUserExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("UserLevel"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.UserLevel = UIIEnums.UserLevel.fromString(j.toString());
                    }
                }
                else if (obj instanceof UIIEnums.UserLevel){
                    this.UserLevel = (UIIEnums.UserLevel)obj;
                }
            }
            return true;
        }
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (UIIUserExtension)__envelope.get(j,UIIUserExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = UIIUserExtension.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
    }
