...
public  class UIIPTZConfigurationExtension extends AttributeContainer implements KvmSerializable
{

    
    private transient java.lang.Object __source;    
    
    public UIIPTControlDirection PTControlDirection;
    
    public UIIPTZConfigurationExtension2 Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("PTControlDirection"))
        {
            if(obj!=null)
            {
                ...
                this.PTControlDirection = (UIIPTControlDirection)__envelope.get(j,UIIPTControlDirection.class,false);
            }
            return true;
        }
        if (info.name.equals("Extension"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Extension = (UIIPTZConfigurationExtension2)__envelope.get(j,UIIPTZConfigurationExtension2.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            if(propertyIndex==0)
            {
                info.type = UIIPTControlDirection.class;
                info.name = "PTControlDirection";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
            else if(propertyIndex==1)
            {
                info.type = UIIPTZConfigurationExtension2.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
    }
