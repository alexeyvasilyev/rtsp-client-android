...
public  class UIIBackupFile extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Data"))
        {
            if(obj!=null)
            {
                ...
                this.Data = (UIIAttachmentData)__envelope.get(j,UIIAttachmentData.class,false);
            }
            return true;
        }
        return false;
