...
public  class UIIPTZPresetTourSupported extends AttributeContainer implements KvmSerializable
{
    ...
    public java.util.ArrayList< UIIEnums.PTZPresetTourOperation> PTZPresetTourOperation =new java.util.ArrayList<UIIEnums.PTZPresetTourOperation >();
    
    public UIIPTZPresetTourSupportedExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("PTZPresetTourOperation"))
        {
            if(obj!=null)
            {
                ...
                {
                    this.PTZPresetTourOperation = new java.util.ArrayList< UIIEnums.PTZPresetTourOperation>();
                }
                java.lang.Object j =obj;
                UIIEnums.PTZPresetTourOperation j1= UIIEnums.PTZPresetTourOperation.fromString(j.toString());
        ...
        if (info.name.equals("Extension"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Extension = (UIIPTZPresetTourSupportedExtension)__envelope.get(j,UIIPTZPresetTourSupportedExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            UIIEnums.PTZPresetTourOperation PTZPresetTourOperation = this.PTZPresetTourOperation.get(propertyIndex-(1));
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = UIIPTZPresetTourSupportedExtension.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
    }
