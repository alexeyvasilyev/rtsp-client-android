...
public class UIISetScopes extends Vector<String> implements KvmSerializable
{
    ...
    public UIISetScopes(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public UIISetScopes(java.util.Collection< String> initialCapactiy)
    {
        super(initialCapactiy);
    }
