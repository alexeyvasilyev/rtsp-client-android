...
public  class UIIPTZNode extends UIIDeviceEntity implements KvmSerializable
{

    
    public String Name;
    
    public UIIPTZSpaces SupportedPTZSpaces;
    ...
    public UIIPTZNodeExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("SupportedPTZSpaces"))
        {
            if(obj!=null)
            {
                ...
                this.SupportedPTZSpaces = (UIIPTZSpaces)__envelope.get(j,UIIPTZSpaces.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("Extension"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.Extension = (UIIPTZNodeExtension)__envelope.get(j,UIIPTZNodeExtension.class,false);
            }
            return true;
        }
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = UIIPTZNodeExtension.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
