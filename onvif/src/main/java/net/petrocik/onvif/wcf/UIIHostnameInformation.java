...
public  class UIIHostnameInformation extends AttributeContainer implements KvmSerializable
{
    ...
    public UIIHostnameInformationExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (UIIHostnameInformationExtension)__envelope.get(j,UIIHostnameInformationExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = UIIHostnameInformationExtension.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
    }
