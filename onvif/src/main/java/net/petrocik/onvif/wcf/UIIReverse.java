...
public  class UIIReverse extends AttributeContainer implements KvmSerializable
{

    
    private transient java.lang.Object __source;    
    
    public UIIEnums.ReverseMode Mode=UIIEnums.ReverseMode.OFF;
        ...
        if (info.name.equals("Mode"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Mode = UIIEnums.ReverseMode.fromString(j.toString());
                    }
                }
                else if (obj instanceof UIIEnums.ReverseMode){
                    this.Mode = (UIIEnums.ReverseMode)obj;
                }
            }
            return true;
        }
