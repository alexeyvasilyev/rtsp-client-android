...
public  class UIIWideDynamicRange20 extends AttributeContainer implements KvmSerializable
{

    
    private transient java.lang.Object __source;    
    
    public UIIEnums.WideDynamicMode Mode=UIIEnums.WideDynamicMode.OFF;
        ...
        if (info.name.equals("Mode"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Mode = UIIEnums.WideDynamicMode.fromString(j.toString());
                    }
                }
                else if (obj instanceof UIIEnums.WideDynamicMode){
                    this.Mode = (UIIEnums.WideDynamicMode)obj;
                }
            }
            return true;
        }
