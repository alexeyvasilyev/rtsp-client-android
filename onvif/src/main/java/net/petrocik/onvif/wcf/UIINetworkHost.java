...
public  class UIINetworkHost extends AttributeContainer implements KvmSerializable
{

    
    private transient java.lang.Object __source;    
    
    public UIIEnums.NetworkHostType Type=UIIEnums.NetworkHostType.IPv4;
    ...
    public UIINetworkHostExtension Extension;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Type"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Type = UIIEnums.NetworkHostType.fromString(j.toString());
                    }
                }
                else if (obj instanceof UIIEnums.NetworkHostType){
                    this.Type = (UIIEnums.NetworkHostType)obj;
                }
            }
            return true;
        }
        ...
        if (info.name.equals("Extension"))
        {
            if(obj!=null)
            {
                ...
                this.Extension = (UIINetworkHostExtension)__envelope.get(j,UIINetworkHostExtension.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            ...
            {
                info.type = UIINetworkHostExtension.class;
                info.name = "Extension";
                info.namespace= "http://www.onvif.org/ver10/schema";
            }
    }
