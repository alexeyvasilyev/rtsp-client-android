...
public  class UIISupportInformation extends AttributeContainer implements KvmSerializable
{

    
    private transient java.lang.Object __source;    
    
    public UIIAttachmentData Binary;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,UIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("Binary"))
        {
            if(obj!=null)
            {
                ...
                this.Binary = (UIIAttachmentData)__envelope.get(j,UIIAttachmentData.class,false);
            }
            return true;
        }
    ...
    public void getPropertyInfo(int propertyIndex, Hashtable arg1, PropertyInfo info)
    {
            if(propertyIndex==0)
            {
                info.type = UIIAttachmentData.class;
                info.name = "Binary";
